    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-6 py-4 max-w-7xl">
          ...
          <h1 className="text-5xl font-black text-primary">Men's Collection</h1>
          <p className="text-lg text-muted-foreground mt-2">
            Discover premium clothing, watches, and shoes
          </p>
        </div>
      </div>
              ...
              <section key={subcategory}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {items.map((product) => (
                    ...
                    >
                      <div className="aspect-square bg-gradient-to-br from-blue-100 to-gray-100 flex items-center justify-center">
                        <ShoppingBag size={64} className="text-blue-500 opacity-50" />
                      </div>
